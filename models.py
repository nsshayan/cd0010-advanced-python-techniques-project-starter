...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has diameter - {self.diameter:.3f} km and {'is' if self.hazardous else 'is not'} hazardous" if not math.isnan((self.diameter)) else f"NEO {self.fullname} has a diameter of {self.diameter:.3f} km and {'is' if self.hazardous else 'is not'} hazardous."
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname for this object.
        return datetime_to_str(self.time) if self.time else "Time is empty"
